  <div class="row g-4">
      ...
      <?php $__currentLoopData = $female_eyeglasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="productImg">
                    <a href="<?php echo e(route('product-detail', $product->slug)); ?>">
                        <div class="imgCol">
                            ...
                            <img src="<?php echo e(asset($product->photo)); ?>" id="female_eyeglass_pro_img_<?php echo e($product->id); ?>" alt="Product " >
                            <?php else: ?>
...
<?php /**PATH C:\laragon\www\eyewear\resources\views/frontend/pages/section/female_eyeglass.blade.php ENDPATH**/ ?>