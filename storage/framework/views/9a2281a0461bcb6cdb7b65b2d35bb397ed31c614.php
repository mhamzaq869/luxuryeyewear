...
<body>
                    ...
                    <div class="row gy-5">
                        <div class="col-xl-auto col-lg-12 col-sm-12 ">
                            <div class="foot_logo_content">
                                ...
                                <p class="whiteColor"><?php echo $site_setting->short_des; ?></p>
    ...
    <?php echo $__env->make('scripts.frontend.filterJs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('scripts.frontend.currencyConvertorJs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
