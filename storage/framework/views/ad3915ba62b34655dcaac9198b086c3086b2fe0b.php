...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        var current_product = "<?php echo e($sunglasses->count()); ?>"
        ...
        function loadMoreData(page){
            $.ajax({
                url: "<?php echo e(url('load_more_sunglass')); ?>"+window.location.pathname+'?page=' + page,
                method: "get",
                dataType: "json",
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\eyewear\resources\views/frontend/pages/sunglass.blade.php ENDPATH**/ ?>