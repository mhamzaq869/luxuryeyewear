...

{
    ...
    protected $fillable=['title','slug','frame_type','summary','photo','status','is_parent','parent_id','added_by','brand_id','size'];
    ...
    public function parent_info(){
     ...
     public function frame_type(){
        ...
        return $this->belongsTo('App\Models\Attribute','frame_type');
    ...
    public static function getAllCategory(){
        ...
        return  Category::orderBy('title')->with('parent_info')->paginate(10);
