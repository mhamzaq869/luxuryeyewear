...
@section('main-content')
    ...
    <div class="p-3">
        ...
        <h5 class="m-0 font-weight-bold text-dark mb-3">Edit User</h5>
                ...
                <div class="card-body">
                    ...
                    <div class="row my-4">
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                    {{ in_array('dashboard', $userBackendPermsion) == true ? 'checked' : '' }}
                                    name="permission[]" value="dashboard" id="flexCheckDefault">
                                <label class="form-check-label" for="flexCheckDefault">Dashboard</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('manager_banners', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="manager_banners" id="banner">
                                <label class="form-check-label" for="banner">Manager Banners</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('product_color', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="product_color" id="product_color">
                                <label class="form-check-label" for="product_color">Product Color</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('attribute', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="attribute" id="attribute">
                                <label class="form-check-label" for="attribute">Attribute</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('category', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="category" id="category">
                                <label class="form-check-label" for="category">Category</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('product', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="product" id="product">
                                <label class="form-check-label" for="product">Product</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('brand', $userBackendPermsion) == true ? 'checked' : '' }} value="brand"
                                    id="brand">
                                <label class="form-check-label" for="brand">Brand</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('shipping', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="shipping" id="shipping">
                                <label class="form-check-label" for="shipping">Shipping</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('order', $userBackendPermsion) == true ? 'checked' : '' }} value="order"
                                    id="order">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('reviews', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="reviews" id="order">
                                <label class="form-check-label" for="order">Reviews</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('post', $userBackendPermsion) == true ? 'checked' : '' }} value="post"
                                    id="post">
                                <label class="form-check-label" for="post">Post</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('post_category', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="post_category" id="post_category">
                                <label class="form-check-label" for="post_category">Post Category</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('tags', $userBackendPermsion) == true ? 'checked' : '' }} value="tags"
                                    id="tags">
                                <label class="form-check-label" for="tags">Tags</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('comment', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="comment" id="comment">
                                <label class="form-check-label" for="comment">Comment</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('coupon', $userBackendPermsion) == true ? 'checked' : '' }} value="coupon"
                                    id="coupon">
                                <label class="form-check-label" for="coupon">Coupon</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('users', $userBackendPermsion) == true ? 'checked' : '' }} value="users"
                                    id="users">
                                <label class="form-check-label" for="users">Users</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('setting', $userBackendPermsion) == true ? 'checked' : '' }}
                    ...
                    <div class="row my-4">
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
                                    {{ in_array('dashboard', $userBackendPermsion) == true ? 'checked' : '' }}
                                    value="dashboard" id="flexCheckDefault">
                                <label class="form-check-label" for="flexCheckDefault">Dashboard</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="permission[]"
