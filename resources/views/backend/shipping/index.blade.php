...
@section('main-content')
    ...
    <div class="p-3 mb-4">
        ...
        <div class="row">
            <div class="col-9">
                <h3 class="m-0 font-weight-bold text-dark">Shipping List</h3>
            </div>
            <div class="col-3 text-end">
                <a href="{{ route('shipping.create') }}" class="btn btn-primary btn-sm mb-3 float-right" data-toggle="tooltip"
