...
@section('main-content')
    ...
    <div class="p-3">
        ...
        <h5 class="m-0 font-weight-bold text-dark mb-3">Edit Shipping</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="select2 form-control " id="countries" name="countries[]"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Transit From<span
                                class="text-danger">*</span></label>
                        <input type="date" name="transitfrom" placeholder="5-10" value="{{ $shipping->transitfrom }}"
                            class="form-control">
                        @error('type')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="transitto" placeholder="5-10" value="{{ $shipping->transitto }}"
                            class="form-control">
                        @error('type')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
