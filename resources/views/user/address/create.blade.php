    ...
    <form action="{{route('user.address.create')}}" method="Post" class="form">
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
              ...
              <input type="text" name="first_name" id="name" placeholder="Enter your first name" class="form-control form-field" value="">
            </div>
            <div class="col-12 col-lg-6">
              <label class="label">Last Name</label>
              <input type="text" name="last_name" id="name" placeholder="Enter your last name" class="form-control form-field" value="">
            </div>
          </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <input type="text" name="email" id="name" placeholder="Enter your email" class="form-control form-field" value="">
              </div>
                ...
                <select class="form-control form-field country" name="country_id" id="country" required="">
                    ...
                    @foreach ($countries as $country)
                        <option value="{{ $country->id }}"
                            {{ $country->id == Auth::user()->country_id ? 'selected' : '' }}>{{ $country->name }}</option>
                    @endforeach
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <textarea type="text" class="form-control form-field" rows="3" name="company" id="address"
                    placeholder="Company (optional)"></textarea>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <textarea type="text" class="form-control form-field" rows="3" name="address_1" id="address"
                    placeholder="Enter your address detail here..."></textarea>
