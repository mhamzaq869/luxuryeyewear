...
<h1 class="side-title">My Profile</h1>
            <form action="{{route('user-profile-update',[Auth::id()])}}" method="Post" class="form">
                @csrf
              <div class="row">
                <div class="col-12 col-lg-6">
                  <label class="label">First Name</label>
                  <input type="text" name="first_name" value="{{Auth::user()->first_name}}" placeholder="Enter your first name" class="form-control form-field" value="">
                </div>
                <div class="col-12 col-lg-6">
                  <label class="label">Last Name</label>
                  <input type="text" name="last_name" value="{{Auth::user()->last_name}}" placeholder="Enter your last name" class="form-control form-field" value="">
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12 col-lg-6">
                  ...
                  <input type="text" name="email" id="email" value="{{Auth::user()->email}}" disabled placeholder="Enter your email" class="form-control form-field " value="">
                </div>
              ...
              <div class="row">
                <div class="col-12 col-lg-6">
                  ...
                  <input type="text" name="city" id="city" value="{{Auth::user()->city}}" required="" placeholder="Enter your city" class="form-control form-field" value="">
                </div>
                <div class="col-12 col-lg-6">
