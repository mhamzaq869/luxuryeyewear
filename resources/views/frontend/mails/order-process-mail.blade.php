...
<p style="color: #333333;">You'll receive an email when your items are shipped. If you have any questions, Call us {{$admin_data->admin_mobile}}.</p>
</td>
</tr>
...
<tbody>
<tr>
<td class="esd-block-text es-p20l" align="center">
<h4>NAME</h4>
</td>
<td class="esd-block-text es-p20l" align="center">
<h4>QTY</h4>
...
<td class="esd-block-image" align="center" style="font-size:0">
    ...
    @if(!empty($product->category_image_name)) 
        <img src="{{asset('uploaded_files/product/'.$product->category_image_name)}}" class="adapt-img" title="{{$product->category_name}}" width="95">
    @else
        <img  src="{{ asset('admin_assets/images/no_image.jpg') }}" class="adapt-img" alt="...." width="95">
    @endif
