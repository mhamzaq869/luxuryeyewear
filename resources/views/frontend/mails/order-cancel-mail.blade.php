                            ...
                            <tbody>
                                <tr>
                                    <td align="center" bgcolor="#c44d39" style="background-color: #ff9933;">
                                        ...
                                        <table class="es-header-body" style="background-color: #ff9933;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#ff9933" align="center">
                                            <tbody>
                                                <tr>
                                                    <td width="270" align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td align="right" esd-links-color="#ffffff"
                                                                        class="esd-block-text es-m-txt-c">
                                                                        <p style="color: #ffffff;margin-right:10px;"><a
                                                                                target="_blank" style="color: #ffffff;"
                                                                                class="view"><i
                                                                                    class="fa fa-phone"></i>
                                                                                {{-- {{ $admin_data->admin_mobile }} --}}
                                                                            </a></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-block-text es-m-txt-c">
                                                                        <p style="margin-left:20px;">
                                                                            <img
                                                                                src="{{ asset('uploaded_files/logo/' . $admin_data->admin_logo) }}">
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                                    ...
                                                                                    <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l"
                                                                                        ...
                                                                                        <p style="color: #333333;">
                                                                                            ...
                                                                                            @if ($order->tracking_no)
                                                                                                <h3>Your Order Tracking
                                                                                                    No is:
                                                                                                    <b>{{ $order->tracking_no }}</b>
                                                                                                </h3>
                                                                                            @endif
                                                                                        </p>
                                                                                    </td>
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{ $order_id }}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{ $order->order_currency_symbol . $order->order_net_amount }}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                    ...
                                    <td class="esd-stripe" esd-custom-block-id="1758" align="center">
                                        <table class="es-content-body" width="600" cellspacing="0"
                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                    $ord_count = DB::table('order_details')
                                                                                    ...
                                                                                    <tr>
                                                                                        <td class="esd-block-image"
                                                                                            ...
                                                                                            style="font-size:0"><a
                                                                                                href="#"
                                                                                                target="_blank"><img
                                                                                                    src="{{ asset('uploaded_files/product/' . $product->category_image_name) }}"
                                                                                                    class="adapt-img"
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>{{ $product->category_name }}
                                                                                                            @if (!empty($detail->lens_id))
                                                                                                                ...
                                                                                                                @php
                                                                                                                    $vision_detail = DB::table('visions')
                                                                                                                        ->where('id', $detail->vision_id)
                                                                                                                        ->first();
                                                                                                                    $lens_detail = DB::table('lenses')
                                                                                                                        ->where('id', $detail->lens_id)
                                                                                                                        ->first();
                                                                                                                    $lens_color_type = DB::table('lens_color_types')
                                                                                                                        ->where('id', $detail->lens_color_id)
                                                                                                                        ->first();
                                                                                                                    $lens_index = DB::table('lens_index')
                                                                                                                        ->where('id', $lens_detail->lens_index)
                                                                                                                        ->first();
                                                                                                                @endphp
                                                                                                                <p>Vision:
                                                                                                                    {{ $vision_detail->vision_name }}
                                                                                                                    @if ($detail->vision_price == 0.0)
                                                                                                                        (Free)
                                                                                                                    @else
                                                                                                                ...
                                                                                                                @php
                                                                                                                    $lens_color_parent = DB::table('lens_color_types')
                                                                                                                        ->where('id', $lens_color_type->category_parent_id)
                                                                                                                        ->first();
                                                                                                                @endphp
                                                                                                                @if ($detail->is_tint == 'tint')
                                                                                                                    <p>Color
                                                                                                                        Type:
                                                                                                                        {{ $lens_color_parent->category_name }}
                                                                                                                        -
                                                                                                                        {{ $lens_color_type->category_name }}
                                                                                                                        @if ($detail->lens_color_price == 0.0)
                                                                                                                            -
                                                                                                                            Free
                                                                                                                        @else
                                                                                                                            -
                                                                                                                ...
                                                                                                                @if ($detail->is_prism == 'Yes')
                                                                                                                    <p>Prism:
                                                                                                                        {{ $order->order_currency_symbol . $detail->prism_price }}
                                                                                                                    </p>
                                                                                                                @endif

                                                                                                                @php
                                                                                                                    $coat_price = '0.00';
                                                                                                                    $check_coating = DB::table('order_coating')
                                                                                                                        ->where('order_id', $detail->id)
                                                                                                                        ->count();
                                                                                                                @endphp
                                                                                                                @if ($check_coating > 0)
                                                                                                                    @php
                                                                                                                        $coatings = DB::table('order_coating')
                                                                                                                            ->where('order_id', $detail->id)
                                                                                                                            ->get();
                                                                                                                    ...
                                                                                                                    <p>Lens
                                                                                                                        Coating:
                                                                                                                        {{ $order->order_currency_symbol . $coat_price }}
                                                                                                                    </p>
                                                                                                                @endif
                                                                                                            @endif
                                                                                        ...
                                                                                        <table style="width: 500px;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 18px; line-height: 150%;">
                                                                                                        {{ $order->order_currency_symbol . $order->order_amount }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 18px; line-height: 150%;">
                                                                                                        {{ $order->order_currency_symbol . $order->order_discount }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td
                                                                                                    ...
                                                                                                    <td
                                                                                                        ...
                                                                                                        <strong>{{ $order->order_currency_symbol . $order->order_net_amount }}</strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-m-txt-c"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                src="{{ asset('uploaded_files/logo/' . $admin_data->admin_logo) }}"
                                                                                                alt="{{ $admin_data->admin_company_name }}"
                                                                                                title="{{ $admin_data->admin_company_name }}"
                                                                                                width="108"></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p5b es-m-txt-c"
                                                                                        align="left">
                                                                                        <p>{{ $admin_data->admin_address }}
                                                                                            <br>
                                                                                            {{ $admin_data->admin_city }},
                                                                                            {{ $admin_data->admin_state }}
                                                                                            <br>
                                                                                            {{ $admin_data->admin_zip_code }},
                                                                                            {{ $admin_data->admin_country }}
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-m-txt-c"
                                                                                        align="left">
                                                                                        <p><a target="_blank"
                                                                                                href="tel:{{ $admin_data->admin_mobile }}">{{ $admin_data->admin_mobile }}</a><br><a
                                                                                                target="_blank"
                                                                                                href="mailto:{{ $admin_data->email }}">{{ $admin_data->email }}</a>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c"
                                                                                        align="left">
                                                                                        <p><a target="_blank"
                                                                                                href="{{ url('/') }}">{{ $admin_data->admin_company_name }}
                                                                                            </a><br></p>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                                href="{{ url('/terms-and-conditions.html') }}"
                                                                                                style="line-height: 150%; font-size: 12px;"
                                                                                                class="unsubscribe">Terms
                                                                                                & Conditions</a> ♦ <a
                                                                                                target="_blank"
                                                                                                href="{{ url('/privacy-policy.html') }}"
