...
@section('main-content')
                            ...
                            @foreach ($brand_img as $brands)
                                <div class="swiper-slide">
                                    <a href="{{ route('product-brand', [$brands->slug]) }}">
                                        <img src="{{ asset($brands->brand_image) }}" alt="{{ $brands->title }}"
                                            title="{{ $brands->title }}">
                                    </a>
                                </div>
                            @endforeach
    ...
    @php
        $female_eyeglass_banner = $banners
            ->where('type', 'female_eyeglass')
            ->where('status', 'active')
            ->first();
        $man_eyeglass_banner = $banners
            ->where('type', 'man_eyeglass')
            ->where('status', 'active')
            ->first();
        $female_sunglass_banner = $banners
            ->where('type', 'female_sunglass')
            ->where('status', 'active')
            ->first();
        $man_sunglass_banner = $banners
            ->where('type', 'man_sunglass')
            ->where('status', 'active')
            ->first();
            ...
            <div class="container">
                                ...
                                <div class="row text-end">
                                    <div class="col">
                                        <div class="core_coll_shop_btn">
                                            <a href="{{ route('front.sunglass.page', ['women']) }}"
                                                class="btn btnShop darkBGColor whiteColor whiteColor"
                                                href="#">SHOP</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="productColMain">
                    ...
                    <div class="btnCol text-center">
                        <a href="{{ route('front.sunglass.page', ['women']) }}" class="btn btnPrimary minWdBtn btnNew">Shop
                            Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="productsCol section_space pb-0">
            <div class="container">
                    ...
                    <div class="row gx-0 align-items-center">
                        ...
                        <div class="col-sm-6">
                            <div class="collection_col whiteBGColor core_coll_block_padding collection_col_right">
                                <h2 class="darkColor">
                                    {{ $man_sunglass_banner->title ?? 'Male Sunglasses Core Collection' }} </h2>
                                <div class="line"></div>
                                <div class="row text-end">
                                    <div class="col">
                                        <div class="core_coll_shop_btn">
                                            <a href="{{ route('front.sunglass.page', ['men']) }}"
                                                class="btn btnShop darkBGColor whiteColor whiteColor">SHOP</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="productColMain">
                    ...
                    <!-- male sun glass  -->
                    <div class="btnCol text-center">
                        <a href="{{ route('front.sunglass.page', ['men']) }}" class="btn btnPrimary minWdBtn btnNew">Shop
                            Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="productsCol section_space pt-0">
            <div class="container">
                        ...
                        <div class="col-sm-6">
                            <div class="core_coll_img">
                                @if ($female_eyeglass_banner)
                                    <img src="{{ asset($female_eyeglass_banner->photo) }}" alt="Image Not Found">
                                @else
                                    <img src="{{ asset('assets/./images/female_eye_glass.png') }}"
                                        alt="Image of female eye glass ">
                                @endif
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="collection_col whiteBGColor core_coll_block_padding">
                                ...
                                <div class="row text-end">
                                    <div class="col">
                                        <div class="core_coll_shop_btn">
                                            <a href="{{ route('front.eyeglass.page', ['women']) }}"
                                                class="btn btnShop darkBGColor whiteColor whiteColor"
                                                href="#">SHOP</a>
                                        </div>
                                    </div>
                ...
                <div class="productColMain">
                    ...
                    <div class="btnCol text-center">
                        <a href="{{ route('front.eyeglass.page', ['women']) }}" class="btn btnPrimary minWdBtn btnNew">Shop
                            Now</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="bgLight">
                    <div class="row gx-0 align-items-center">
                        ...
                        <div class="col-sm-6">
                            <div class="collection_col whiteBGColor core_coll_block_padding collection_col_right">
                                <h2 class="darkColor">{{ $man_eyeglass_banner->title ?? ' Eyeglasses Core Collection' }}
                                </h2>
                                <div class="line"></div>
                                <div class="row text-end">
                                    <div class="col">
                                        <div class="core_coll_shop_btn">
                                            <a href="{{ route('front.eyeglass.page', ['men']) }}"
                                                class="btn btnShop darkBGColor whiteColor whiteColor">SHOP</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="productColMain">
                    ...
                    <!-- male sunglass  -->
                    <div class="btnCol text-center">
                        <a href="{{ route('front.eyeglass.page', ['men']) }}" class="btn btnPrimary minWdBtn btnNew">Shop
                            Now</a>
                    </div>
                </div>
            </div>
