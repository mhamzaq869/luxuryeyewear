                    ...
                    <ul>
                        ...
                        @if (isset($i) && $i > 2)
                            @if (count($product_variant->whereIn('product_for', [28, 30])) - 4 != 0)
                                <li style="padding: 0">
                                    <a href="{{ route('product-detail', [$product->slug]) }}" style="padding: 14px"
                                        target="_blank" class="text-danger m-2">
                                        @if (count(
                                            $product_variant->where('cat_id', $product->cat_id)->whereIn('product_for', [$product->product_for, 30])) -
                                            4 >
                                            0)
