              ...
              <div class="col-md-6 col-xl-4">
                <div class="cardStyle1">
                  ...
                  <div class="contentCol">
                    ...
                    <p>	<p class="product-name"><a href="{{route('product-detail',$wishlist->product['slug'])}}">{{$wishlist->product['title']}}</a></p>
                    <span class="priceCol">${{$wishlist['amount']}} </span>
                    <div class="row gx-2">
                      <div class="col-auto">
                        <a href="{{route('add-to-cart',$wishlist->product['slug'])}}" class="btn btnDark w-100 addCartBtn">ADD TO CART</a>
                      </div>
                      <div class="col">
                        <a href="{{route('wishlist-delete',$wishlist->id)}}" class="btn btnDark_outline w-100">Remove</a>
